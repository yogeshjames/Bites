...
const Checkbox = ({ size = '50px' }) => {

  // Effect hook to update the CSS variable dynamically
  useEffect(() => {
    document.documentElement.style.setProperty('--size', size); // Update --size variable
  }, [size]);
...
const StyledWrapper = styled.div`
  ...
  .checkbox-wrapper label {
    --size: ${(props) => props.size}; /* Use dynamic size from props */
