...
const StyledWrapper = styled.div`
  ...
  *::before {
  ...
  .suns {
    ...
    top: 8px;     /* Adjusted to fit */
    right: 20px;  /* Adjusted to fit */
  ...
  /* Adjusting the other elements proportionally to maintain the design balance */
  .slider:checked + .switch .bb8 {
    left: 25%;
  }
