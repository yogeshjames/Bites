...
const StyledWrapper = styled.div`
  .loader {
    ...
    height: 60px; /* Adjust height to match the reduced size */
    display: flex;
    align-items: center;
    justify-content: center;
    margin-left: 10px; /* Optional: space between loader and other components */
  }
  ...
  /* truck upper body */
  .truckBody {
    width: 80px; /* Reduce the size of the truck body */
    height: fit-content;
  ...
  .truckTires svg {
    width: 18px; /* Smaller tire icons */
  }

  .road {
    width: 100%;
    height: 1px; /* Reduced road thickness */
  ...
  .road::before {
    content: "";
    position: absolute;
    width: 10px; /* Adjust width of the road line */
    height: 100%;
    background-color: #282828;
    right: -50%;
    border-radius: 3px;
  ...
  .road::after {
    content: "";
    position: absolute;
    width: 8px; /* Adjust width of the road line */
    height: 100%;
    background-color: #282828;
    right: -65%;
    border-radius: 3px;
